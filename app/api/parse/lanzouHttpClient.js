...
import { isAcwChallenge, calcAcwScV2FromHtml, upsertAcwScCookie, } from "./anti_acw_sc__v2.js";
...
function randIP() {
    ...
    return `${arr[Math.floor(Math.random() * arr.length)]}.${Math.floor(Math.random() * 255)}.${Math.floor(Math.random() * 255)}.${Math.floor(Math.random() * 255)}`;
}
/**
 * 获取请求头
 */
...
//# sourceMappingURL=lanzouHttpClient.js.map